export default () => ({
  list_sections: [
    ...
    },
    {
      ...
      subtitle: "Вся информация по тендерам и закупкам компании по 44 и 223 ФЗ",
      list: [
    ...
    info: [
      {
        ...
        list: [
          {
            text: "Выписка из ЕГРЮЛ/ЕГРИП заверенная ЭЦП",
            src: "egrul.pdf",
            name: "pdf"
          },
          {
            text: "Выписка из реестра недвижимости",
            src: "egrn.pdf",
            name: "pdf"
          },
          {
            text: "Архивная выписка из реестра недвижимости",
            src: "egrn_arhiv.pdf",
            name: "pdf"
          },
          {
            text: 'Отчет "Проявление должной осмотрительности"',
            src: "pdo.pdf",
            name: "pdf"
          }
        ],
    ...
    info: [
      {
        ...
        list: [
          ...
          {
            text: "Выписка ЕГРН (Единый государственный реестр недвижимости)",
            src: "egrn.pdf",
            name: "pdf"
          },
