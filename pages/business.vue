            ...
            list: [
              {
                ...
                href:
                  "http://1clicom.ru/soft/releases/lic_business_win_2.4.0.zip",
                download: true
              },
              {
                ...
                icon: "mdi-file",
                href:
                  "http://1clicom.ru/instruction/manual_LICbusiness2_win.pdf",
                download: true
              },
              {
                ...
                icon: "mdi-microsoft-windows",
                href:
                  "http://1clicom.ru/soft/releases/lic_business_win_2.3.7-XP.zip",
                download: true
              }
            ],
            page: 0
            ...
            list: [
              {
                ...
                src: "1c-logo",
                href: "http://1clicom.ru/soft/LicBusinessOP_2_3_4_12.epf",
              ...
              },
              {
                ...
                src: "1c-logo",
                href: "http://1clicom.ru/soft/LicBusinessUP_2_3_4_12.epf",
                download: true
              },
              {
                ...
                icon: "mdi-file",
                href:
                  "http://1clicom.ru/instruction/rukovodstvo_lic_biz-kontr.pdf",
                download: true
              }
            ],
            page: 1,
